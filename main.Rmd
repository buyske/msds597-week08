...
separate_bounds <- function(x) {
  x <- separate(x, Num_hom, into = c("num_hom", "bounds"), sep = "\\[",fill = "right")
  x$bounds <- str_replace_all(x$bounds, "\\]", "")
  x <- separate(x, bounds, into = c("num_lower_bound", "num_upper_bound"), sep = "\\-",fill = "right")
  x <- separate(x, Hom_rate, into = c("hom_rate", "bounds"), sep = "\\[",fill = "right")
  x$bounds <- str_replace_all(x$bounds, "\\]", "")
  x <- separate(x, bounds, into = c("rate_lower_bound", "rate_upper_bound"), sep = "\\-",fill = "right")
...
viol_hom <- fix_who_column(viol_hom)
